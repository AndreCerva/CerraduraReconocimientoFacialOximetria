...
import time,os#Libreria para tiempos de espera 
...
load_dotenv()
CONNECTION_STRING =os.getenv("CONNECTION_STRING") #Aquí pegamos la cadena de conexion tomada desde nuestro portal de azure
